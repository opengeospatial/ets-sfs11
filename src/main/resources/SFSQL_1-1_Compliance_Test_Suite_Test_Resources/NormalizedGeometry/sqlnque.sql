...
-- 
-- This file "sqlnque.sql" is part 2 of a two part standardized test
-- suite in SQL script form. The other file that is required for this test
-- suite, "sqlnsch.sql", one additional script is provided ("sqlncle.sql") that
-- performs cleanup operations between test runs, and other other documents 
-- that describe the OGC Conformance Test Program and specifically this Test 
-- Suite are available via the WWW at http://www.opengeospatial.org/testing/index.htm
--
...
-- streams table is represented in the GEOMETRY_COLUMNS table/view
--
-- ANSWER: 3 (which corrsponds to linestring)	
--
--================================
--
